...
Function EntityToJava(pEntity)
   ...
   fileMapper.Write " */" + vbCrLf
   fileMapper.Write "public interface "+FirstCharToU(pEntity.Code)+"Mapper {" + vbCrLf
...
Function insertMapperImportPage(file,entity)
	...
	file.Write   "import org.apache.ibatis.annotations.Param;"+vbCrLf
    file.Write vbCrLf
...
Function AddMapperMethod(entity)
	 ...
	 AddMapperMethod =  AddMapperMethod + "    * 新增" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * " + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * @param "+FirstCharToL(entity.Code) + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * @return" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    */" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    int insert("+FirstCharToU(entity.Code)+" "+FirstCharToL(entity.Code)+");" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    /**" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * 删除" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * " + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * @param id" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * @return" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    */" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    int deleteByPrimaryKey(@Param(value=""id"")String id);" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    /**" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * 修改" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * " + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * @param "+FirstCharToL(entity.Code) + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * @return" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    */" + vbCrLf
     AddMapperMethod =  AddMapperMethod + "    int updateByPrimaryKey("+FirstCharToU(entity.Code)+" "+FirstCharToL(entity.Code)+");" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    /**" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * 根据id查找" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * " + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * @param id" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * @return" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    */" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    "+FirstCharToU(entity.Code)+" selectByPrimaryKey(@Param(value=""id"")String id);" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    /**" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * 查询" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * " + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * @param "+FirstCharToL(entity.Code) + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    * @return" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    */" + vbCrLf
	 AddMapperMethod =  AddMapperMethod + "    List<"+FirstCharToU(entity.Code)+"> search("+FirstCharToU(entity.Code)+" "+FirstCharToL(entity.Code)+");" + vbCrLf
...
Function AddMapperXmlMethod(pEntity)   
	 ...
	 Dim primaryKey,attr,resultMapStr,BaseColumnStr,valueColumnStr,updateColumnStr,queryColumnStr

	 For Each attr In pEntity.Attributes
	   If Not attr.IsShortcut Then 
			If attr.PrimaryIdentifier Then
			    primaryKey = FirstCharToL(attr.Code)
			...
			valueColumnStr = valueColumnStr+",#{"+GetTableColumName(FirstCharToL(attr.Code))+"}"
			updateColumnStr = updateColumnStr+","+GetTableColumName(FirstCharToL(attr.Code))+"=#{"+FirstCharToL(attr.Code)+"}"
			queryColumnStr = queryColumnStr+"	<if test="""+FirstCharToL(attr.Code)+" != null"">" + vbCrLf
			queryColumnStr = queryColumnStr+"    	and "+GetTableColumName(FirstCharToL(attr.Code))+" = #{"+FirstCharToL(attr.Code)+"} " + vbCrLf
			queryColumnStr = queryColumnStr+"   </if>" + vbCrLf
			
	   End If 
	 Next
	 AddMapperXmlMethod = AddMapperXmlMethod+resultMapStr+"  </resultMap>" + vbCrLf
     AddMapperXmlMethod = AddMapperXmlMethod + "" + vbCrLf
...
'     AddMapperXmlMethod = AddMapperXmlMethod + "  </sql>" + vbCrLf
	 ...
	 AddMapperXmlMethod = AddMapperXmlMethod + "  <insert id=""insert"" parameterType="""+entityPage+"."+FirstCharToU(pEntity.Code)+""" useGeneratedKeys=""true"" >" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    insert into "+table_top + GetTableColumName(FirstCharToL(pEntity.Code))+" (" + Mid(BaseColumnStr,2) +") values " + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    ("+Mid(valueColumnStr,2)+")" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "  </insert>" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "" + vbCrLf

	 AddMapperXmlMethod = AddMapperXmlMethod + "  <delete id=""deleteByPrimaryKey"">" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    delete from "+table_top + GetTableColumName(FirstCharToL(pEntity.Code))+" where  "+primaryKey+" = #{id} " + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "  </delete>" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "" + vbCrLf

	 AddMapperXmlMethod = AddMapperXmlMethod + "  <update id=""updateByPrimaryKey"" parameterType="""+entityPage+"."+FirstCharToU(pEntity.Code)+""">" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    update "+table_top + GetTableColumName(FirstCharToL(pEntity.Code))+" set  " +Mid(updateColumnStr,2)+ vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    where  "+primaryKey+" = #{id} " + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "  </update>" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "" + vbCrLf

	 AddMapperXmlMethod = AddMapperXmlMethod + "  <select id=""selectByPrimaryKey"" resultType="""+FirstCharToU(pEntity.Code)+""">" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    select " + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    <include refid=""Base_Column_List"" />" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    from "+table_top + GetTableColumName(FirstCharToL(pEntity.Code))+"" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    where  "+primaryKey+" = #{id} " + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "  </select>" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "" + vbCrLf

	 AddMapperXmlMethod = AddMapperXmlMethod + "  <select id=""search"" resultType="""+FirstCharToU(pEntity.Code)+"""  parameterType="""+entityPage+"."+FirstCharToU(pEntity.Code)+""">" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    select " + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    <include refid=""Base_Column_List"" />" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    from "+table_top + GetTableColumName(FirstCharToL(pEntity.Code))+"" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "    where 1=1" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + queryColumnStr + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "  </select>" + vbCrLf
	 AddMapperXmlMethod = AddMapperXmlMethod + "" + vbCrLf
End Function
