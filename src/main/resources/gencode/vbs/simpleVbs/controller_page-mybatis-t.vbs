...
Function AddMethod(pEntity)
	 ...
	 AddMethod = AddMethod  + "       String search = request.getParameter(""search"");"+ vbCrLf
	 ...
	 AddMethod = AddMethod  + "       "+ vbCrLf
	 AddMethod = AddMethod  + "       //通过Map方式查询 --通过自动组装方式查询"+ vbCrLf
	 AddMethod = AddMethod  + "       Map<String,String> queryMap = new HashMap<String,String>();"+ vbCrLf
	 AddMethod = AddMethod  + "       if(StringUtils.isNotBlank(searchForm)) {//通过页面""query_""开头命名的属性可自动过滤查询"+ vbCrLf
	 ...
	 AddMethod = AddMethod  + "       PageInfo<"+FirstCharToU(pEntity.Code)+"> pageInfo = this."+FirstCharToL(pEntity.Code)+"Service.queryPagesByMap(queryMap,searchText, pageable);"+ vbCrLf
	 ...
	 AddMethod = AddMethod  + "           "+FirstCharToU(pEntity.Code)+" "+FirstCharToL(pEntity.Code)+" = this."+FirstCharToL(pEntity.Code)+"Service.findOne(id);" + vbCrLf
