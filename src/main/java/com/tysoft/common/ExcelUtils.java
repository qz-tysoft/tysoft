...
public class ExcelUtils {
	...
	public ExcelUtils(String fileName) {
		...
		columnFont.setFontHeight((short)250);
	 ...
	 * @param merges
	 */
	public void createTitle(String title,int startRow,String[] theads,String[] theads2,String[] merges){ 
		HSSFRow row;
		HSSFCell cell; 
	 ...
	 * @param theads
	 */
	public void fillTitleCell(HSSFRow row,String[] theads){
	 ...
	 * @param conditions
	 */
	public void fillCell(List<String[]> list,int startRow,String[] conditions){
		HSSFCell cell = null;
